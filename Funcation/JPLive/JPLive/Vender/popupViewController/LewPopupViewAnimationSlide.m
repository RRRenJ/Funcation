...
- (void)showView:(UIView *)popupView overlayView:(UIView *)overlayView{
    ...
    CGRect popupEndRect = CGRectMake(_popViewPoint_x ? _popViewPoint_x.floatValue : (sourceSize.width - popupSize.width) / 2,
                                     _popViewPoint_y != 0 ? _popViewPoint_y : (sourceSize.height - popupSize.height) / 2,
                                     popupSize.width,
                                     popupSize.height);
...
- (void)dismissView:(UIView *)popupView overlayView:(UIView *)overlayView completion:(void (^)(void))completion{
    if ([self.delegate respondsToSelector:@selector(lewPopupViewWillDissmiss)]){
        [self.delegate lewPopupViewWillDissmiss];
    }
