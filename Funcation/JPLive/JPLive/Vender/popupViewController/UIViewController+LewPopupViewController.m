...
- (NSString *)isLight{
    return objc_getAssociatedObject(self, @"isLight");
}

- (void)setIsLight:(NSString *)isLight{
    objc_setAssociatedObject(self, @"isLight", isLight, OBJC_ASSOCIATION_COPY_NONATOMIC);
}
...
//    popupView.layer.shadowOpacity = 0.5;
    ...
    if (self.lewOverlayView == nil) {
        ...
        // BackgroundView
        LewPopupBackgroundView *backgroundView = [[LewPopupBackgroundView alloc] initWithFrame:sourceView.bounds];
        backgroundView.autoresizingMask = UIViewAutoresizingFlexibleWidth | UIViewAutoresizingFlexibleHeight;
        backgroundView.backgroundColor = [UIColor clearColor];
        backgroundView.isLight = self.isLight;
